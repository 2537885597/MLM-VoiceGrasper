#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# RM-SCR Robot MoveIt! Python Demo
#
# Maintainer: Herman Ye @Realman Robotics
# Date: 2021/06/28
...
def main():
    try:
        print("")
        print("----------------------------------------------------------")
        print("Welcome to the RM-SCR Robot Python Tutorial")
        print("----------------------------------------------------------")
        print("")
        input("============ Press `Enter` to set up the moveit_commander ...")
        tutorial = MoveGroupPythonInterfaceTutorial()
        input(
            "============ Press `Enter` to back to zero goal ..."
        )
        ...
        print("============ RM-SCR Robot Python tutorial demo complete!")
