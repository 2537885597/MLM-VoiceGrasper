...
ros::Publisher cmd_vel_pub;			//创建底盘运动控制器话题发布者
ros::Publisher goal_control_pub;	//创建导航目标点话题发布者
...
int voice_open_off = 0;		//寻找标志位当前状态
int goal_control=0;			//导航目标点标志位
...
int main(int argc, char** argv)
{
  ...
  /***创建自主导航目标点话题发布者***/
	...
	n.param("/command_recognition/audio_path", audio_path, std::string("~/realman_ws/src/xf_mic_asr_offline_line/feedback_voice"));
  ...
  /***用户界面***/
	...
	cout<<"小微右转———————————>右转"<<endl;
	cout<<"小微停———————————>停止"<<endl;
	cout<<"小微休眠———————————>休眠，等待下一次唤醒"<<endl;
	cout<<"小微过来———————————>寻找声源"<<endl;
	cout<<"小微去I点———————————>小微自主导航至I点"<<endl;
	cout<<"小微去J点———————————>小微自主导航至J点"<<endl;
	cout<<"小微去K点———————————>小微自主导航至K点"<<endl;
	cout<<"小微雷达跟随———————————>小微打开雷达跟随"<<endl;
	cout<<"关闭雷达跟随———————————>小微关闭雷达跟随"<<endl;
	cout<<"小微色块跟随———————————>小微打开色块跟随"<<endl;
	cout<<"关闭色块跟随———————————>小微关闭色块跟随"<<endl;
	cout<<"打开自主建图———————————>小微打开自主建图"<<endl;
	cout<<"关闭自主建图———————————>关闭打开自主建图"<<endl;
	cout<<"开始导航———————————>小微开始导航"<<endl;
	cout<<"关闭导航———————————>小微关闭导航"<<endl;
	cout<<"\n"<<endl;
